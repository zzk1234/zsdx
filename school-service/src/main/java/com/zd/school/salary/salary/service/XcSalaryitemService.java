...
/**
 * 
 * ClassName: XcSalaryitemService
 * Function: TODO ADD FUNCTION. 
 * Reason: TODO ADD REASON(可选). 
 * Description: 工资项定义表(XC_T_SALARYITEM)实体Service接口类.
 * date: 2016-12-12
 *
 * @author  luoyibo 创建文件
 * @version 0.1
...
public interface XcSalaryitemService extends BaseService<XcSalaryitem> {
    ...
    public QueryResult<XcSalaryitem> list(Integer start, Integer limit, String sort, String filter, String whereSql,String orderSql,
            SysUser currentUser); 
	/**
	 * 根据主键逻辑删除数据
	 * 
