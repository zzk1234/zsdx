package com.zd.school.IpControl.IpControl.service;
...
/**
 * 
 * ClassName: SysIpService
 * Function: TODO ADD FUNCTION. 
 * Reason: TODO ADD REASON(可选). 
 * Description: (SYS_T_IP)实体Service接口类.
 * date: 2017-05-10
 *
 * @author  luoyibo 创建文件
 * @version 0.1
...
public interface SysIpService extends BaseService<SysIp> {
