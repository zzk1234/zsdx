...
/**
 * 
 * ClassName: TrainCreditsruleService
 * Function: TODO ADD FUNCTION. 
 * Reason: TODO ADD REASON(可选). 
 * Description: 学分计算规则(TRAIN_T_CREDITSRULE)实体Service接口类.
 * date: 2017-03-07
 *
 * @author  luoyibo 创建文件
 * @version 0.1
...
public interface TrainCreditsruleService extends BaseService<TrainCreditsrule> {
