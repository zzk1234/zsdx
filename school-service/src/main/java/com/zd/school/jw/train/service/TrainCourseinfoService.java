...
/**
 * 
 * ClassName: TrainCourseinfoService
 * Function:
 * Reason:
 * Description: 课程信息(TRAIN_T_COURSEINFO)实体Service接口类.
 * date: 2017-03-07
 *
 * @author  luoyibo 创建文件
 * @version 0.1
...
public interface TrainCourseinfoService extends BaseService<TrainCourseinfo> {
	...
	/**
	 * 导出课程信息
	 * @param ids 要课程ID，如ID为空则导出所有的课程信息
	 * @param orderSql 导出数据的排序条件
	 * @return
	 */
