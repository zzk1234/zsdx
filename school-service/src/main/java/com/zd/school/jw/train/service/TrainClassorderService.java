...
/**
 * 
 * ClassName: TrainClassorderService
 * Function: TODO ADD FUNCTION. 
 * Reason: TODO ADD REASON(可选). 
 * Description: 班级订餐/住宿信息(TRAIN_T_CLASSORDER)实体Service接口类.
 * date: 2017-03-07
 *
 * @author  luoyibo 创建文件
 * @version 0.1
...
public interface TrainClassorderService extends BaseService<TrainClassorder> {
