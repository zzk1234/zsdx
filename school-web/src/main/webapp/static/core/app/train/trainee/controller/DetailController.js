 ...
 */
Ext.define("core.train.trainee.controller.DetailController", {
    extend: "Ext.app.ViewController",
    alias: 'controller.trainee.detailController',
    mixins: {
        /*
    ...
    doRecordCourseClick_Tab: function (btn, cmd, grid, record) {
        ...
        var itemXtype = "trainee.trainrecordcoursegrid";
        ...
        if (!tabItem) {
            ...
            setTimeout(function () {
                ...
                tabItem.add(item);
                var trainRecordGrid = tabItem.down("grid[xtype=trainee.trainrecordcoursegrid]");
