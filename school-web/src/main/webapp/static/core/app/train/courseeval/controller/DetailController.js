 ...
 */
Ext.define("core.train.courseeval.controller.DetailController", {
    extend: "Ext.app.ViewController",
    alias: 'controller.courseeval.detailController',
    mixins: {
        /*
    ...
    doRecordCourseClick_Tab: function (btn, cmd, grid, record) {
        ...
        var itemXtype = "courseeval.trainrecordcoursegrid";
        ...
        if (!tabItem) {
            ...
            setTimeout(function () {
                ...
                tabItem.add(item);
                var trainRecordGrid = tabItem.down("grid[xtype=courseeval.trainrecordcoursegrid]");
